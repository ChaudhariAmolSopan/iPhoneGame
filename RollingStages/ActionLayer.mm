...
@synthesize dictionaryForEmitters;
/*
- (id)init
{
    self = [super init];
...
*/
        ...
        emitterMethods = [[UDEmitterMethods alloc] initWithLevelHelper:_lhelper andLevelHelperTag:PARTICLESENSOR];
        
        [self addChild:emitterMethods];
        
        
        UDEmitterMethods *winEmitterMethod =[[UDEmitterMethods alloc]initWithLevelHelper:_lhelper andLevelHelperTag:VICTORY];
        [self addChild:winEmitterMethod];
